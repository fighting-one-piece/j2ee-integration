...
<%@include file="/WEB-INF/views/commons/tag/taglibs.jsp"%>
<es:contentHeader title="" index="true"/>
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        ...
        <a class="brand" style="float: right" href="" target="_blank">&nbsp;&nbsp;问题反馈</a>
    </div>
</div>
            ...
            <c:if test="${jcaptchaEbabled}">
                <div class="control-group">
                    ...
                    <div class="input-prepend">
                     ...
                     <img class="jcaptcha-btn jcaptcha-img" style="margin-left: 10px;" src="${contextURL}/jcaptcha.jpg" title="点击更换验证码">
...
<footer class="footer">
    <div class="container">
        ...
        <ul class="footer-links">
            ...
            <li class="muted">·</li>
            <li><a href="" target="_blank">项目主页</a></li>
        </ul>
    </div>
</footer>
<es:contentFooter/>
<script type="text/javascript">
    $(function() {
        ...
        $.validationEngineLanguage.allRules.ajaxJcaptchaCall={
            "url": "${contextURL}/jcaptcha-validate",
