...
<es:contentHeader/>
<%@include file="/WEB-INF/views/commons/import/import-calendar-css.jsp"%>
<style>
    ...
    <div class="row-fluid tool ui-toolbar">
        <div style="padding-left: 10px;">
            <a class="btn btn-link btn-view-info" data-toggle="tooltip" data-placement="bottom" title="点击查看个人资料/修改密码">
                <sys:showLoginUsername/>${nickname}，欢迎您！
            </a>
...
<es:contentFooter/>
<%@include file="/WEB-INF/views/commons/import/import-calendar-js.jsp"%>
<script>
    $(function() {
        $.app.initCommonBtn();
