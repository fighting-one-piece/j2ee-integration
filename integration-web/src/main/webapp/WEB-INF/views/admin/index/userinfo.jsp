            ...
            <ul class="nav btn-group">
                <li class="btn">
                    <a class="btn-view-info" data-toggle="tooltip" data-placement="bottom" title="点击查看个人资料">
                        <sys:showLoginUsername/>${nickname}${user.name}，欢迎您！
                    </a>
                </li>
                    ...
                    <div class="content">
                        <div class="loading">
                            ...
                            <div class="popover-content list">
                                <img src="${contextURL}/static/images/loading.gif" width="20px">&nbsp;&nbsp;&nbsp;加载中...
                            </div>
                        </div>
                ...
                <li class="btn">
                    <a href="${contextURL}/logout" data-toggle="tooltip" data-placement="bottom" title="退出"><i class="icon-large icon-signin"></i></a>
                </li>
            </ul>
        </div>
    </shiro:user>
