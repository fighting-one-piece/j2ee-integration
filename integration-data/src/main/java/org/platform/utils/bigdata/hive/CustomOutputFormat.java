...
public class CustomOutputFormat<K extends WritableComparable, V extends Writable>
	...
	protected static class IgnoreKeyWriter<K extends WritableComparable, V extends Writable>
		...
		private final org.apache.hadoop.mapred.RecordWriter mWriter;

		public IgnoreKeyWriter(
				org.apache.hadoop.mapred.RecordWriter<K, V> writer) {
			this.mWriter = writer;
		}
	...
	public org.apache.hadoop.mapred.RecordWriter<K, V> getRecordWriter(
		...
		return new IgnoreKeyWriter<K, V>(super.getRecordWriter(ignored, job,
				name, progress));
	}
