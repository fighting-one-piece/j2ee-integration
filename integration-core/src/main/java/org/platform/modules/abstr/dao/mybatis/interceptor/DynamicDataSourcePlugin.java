...
import org.platform.utils.datasource.DynamicDataSourceConstants;
import org.platform.utils.datasource.DynamicDataSourceHolder;
...
public class DynamicDataSourcePlugin implements Interceptor {
     ...
     * 动态数据源缓存
     */
    private static final Map<String, DynamicDataSourceConstants> CACHE_MAP = new ConcurrentHashMap<>();
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (!synchronizationActive) {
            ...
            DynamicDataSourceConstants dynamicDataSourceGlobal;
     ...
     */
    private DynamicDataSourceConstants getDynamicDataSource(MappedStatement ms, Object parameterObject) {
    	DynamicDataSourceConstants dynamicDataSourceGlobal;
        //读方法
        if (ms.getSqlCommandType().equals(SqlCommandType.SELECT)) {
            ...
            if (ms.getId().contains(SelectKeyGenerator.SELECT_KEY_SUFFIX)) {
                ...
                if (sql.matches(REGEX)) {
                    ...
                    dynamicDataSourceGlobal = DynamicDataSourceConstants.READ;
                }
            }
        } else {
            dynamicDataSourceGlobal = DynamicDataSourceConstants.WRITE;
