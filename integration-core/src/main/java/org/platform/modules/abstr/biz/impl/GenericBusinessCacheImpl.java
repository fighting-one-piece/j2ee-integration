...
public class GenericBusinessCacheImpl<Entity extends Serializable, PK extends Serializable> 
	...
	@Override
	public IGenericDAO<Entity, PK> obtainDAOInstance() {
		return null;
	}
	
	protected void addCacheManage(int cacheType, GenericBusinessCacheImpl<Entity, PK> cacheInstance) {
	...
	protected void initCache(int cacheType){
		if(null == cacheMap.get(cacheType)) return;
